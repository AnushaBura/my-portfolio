    ...
    <div id="contact" className="bg-[#232533] text-white px-4">
      ...
      >
        ...
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          ...
          <ContactCard
            label="Website:"
            value="https://anushabura.github.io/my-portfolio/"
          />
          <ContactCard label="Address:" value="Celina Texas" />
          <ContactCard
            label="GitHub:"
            value="https://github.com/AnushaBura/my-portfolio"
          />
          <div className="bg-[#2a2d3c] p-6 rounded-md shadow-md border border-gray-600">
            ...
            <div className="flex flex-col gap-2">
              <a
                ...
                className="text-gray-300 text-sm hover:text-pink-400 transition"
              >
